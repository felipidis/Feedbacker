<template>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <p class="mt-10 text-lg text-gray-800 font-regular">Esta é sua chave</p>
      ...
      <p class="mt-10 text-lg text-gray-800 font-regular">
        Insira o script a seguir no seu site para começar a receber seus
        feedbacks !
      </p>
      ...
      >
        <span v-if="state.hasError">Erro ao carregar o script</span>
        <pre v-else>
&lt;script src="https://felipidis-feedbacker-widget.netlify.app?api_key={{
